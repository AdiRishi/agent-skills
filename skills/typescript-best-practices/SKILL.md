...
| Boundary validation | Validate where data crosses in; trust types inside. See [Boundary Discipline](../engineering-principles/references/principle-boundary-discipline.md). |
