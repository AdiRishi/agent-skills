...
Apply [Type System Discipline](../engineering-principles/references/principle-type-system-discipline.md) first; this skill grounds it in TypeScript syntax.
...
| Boundary validation | Parse where data crosses in, into a named domain type. `Record<string, unknown>` (however spelled) stops at that parse. Trust types inside. See [Boundary Discipline](../engineering-principles/references/principle-boundary-discipline.md). |
